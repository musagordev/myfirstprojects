...
urlpatterns = [
    ...
    path('thing/<int:pk>/comment', views.CommentCreateView.as_view(), name='thing_comment_create'),
    path('thing_picture/<int:pk>', views.stream_file, name='thing_picture'),
    path('comment/<int:pk>/delete', views.CommentDeleteView.as_view(success_url=reverse_lazy('thing:all')), name='thing_comment_delete'),]
